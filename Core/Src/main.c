...
static void I2C_SSD1306_Screen_Init(void);
/* USER CODE BEGIN PFP */
...
int main(void)
{
  ...
  void screen_transmit(uint8_t data_len, uint8_t * data){
	  HAL_I2C_Master_Transmit(&hi2c1, ((uint16_t)0x3c)<<1, data, data_len, 1000);
  }
