...
//	uint8_t command_data[13] = {0x80, 0x21, 0x80, 0x0, 0x80, 127, 0x80, 0x22, 0x80, 0x00, 0x80, 0x07};
//	I2C_SSD1306_Screen_Transmit(13, &command_data);
//	HAL_Delay(1000);
  
//	 while(1){
//	 	uint8_t data[2] = {0x40, 0b00000000};
//	 	I2C_SSD1306_Screen_Transmit(2, data);
//	 }
...
void I2C_SSD1306_Update_Whole_Display(uint8_t SSD1306_FrameBufferPages[128][8]){
	...
	uint8_t command_data[12] = {0x80, 0x21, 0x80, 0x0, 0x80, 127, 0x80, 0x22, 0x80, 0x00, 0x80, 0x07};
...
static void I2C_SSD1306_Screen_Transmit(uint16_t data_len, uint8_t * data){
	  HAL_I2C_Master_Transmit(&hi2c1, ((uint16_t)0x3c)<<1, data, data_len, 100);
}
/* USER CODE END 4 */
